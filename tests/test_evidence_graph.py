...
def test_catalog_deduplicates_facts_and_links_unchanged_path_symbols() -> None:
    ...
    assert catalog.schema_version == "evidence_catalog.v19"
...
def test_review_brief_serializes_one_canonical_catalog() -> None:
    ...
    assert brief.schema_version == "review_brief.v56"
    ...
    assert serialized["projection"]["schema_version"] == "review_projection.v32"
    assert serialized["projection"]["architectural_topology"][
        "schema_version"
    ] == "architectural_change_topology.v3"
